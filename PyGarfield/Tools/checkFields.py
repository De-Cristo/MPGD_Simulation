...
fmpath = '/data/pubfs/zhanglic/workspace/MPGD_Simulation/CMS_4GEM_base/CMS_4GEM_1HV/3400V/'
...
pitch = 0.0140
# sensor.SetArea(-5 * pitch, -5 * pitch, -0.0030, 5 * pitch,  5 * pitch, 1.3040)
...
# hxz = R.TH2D("XZ_field","E field", pixal1, -5 * pitch, 5 * pitch, pixal2, lowerbound, upperbound)
# for ix in range(0,pixal1):
#     for iz in range(0,pixal2):
#         x = (5 * pitch--5 * pitch)*ix/pixal1+-5 * pitch
...
# hxz = R.TH2D("XZ_Volt","Potential", pixal1, -5 * pitch, 5 * pitch, pixal2, lowerbound, upperbound)
# for ix in range(0,pixal1):
#     for iz in range(0,pixal2):
#         x = (5 * pitch--5 * pitch)*ix/pixal1+-5 * pitch
#         z = (upperbound-lowerbound)*iz/pixal2+lowerbound
...
# hxy = R.TH2D("XY_field","E field", pixal1, -5 * pitch, 5 * pitch, pixal1, -5 * pitch, 5 * pitch)
# for ix in range(0,pixal1):
#     for iy in range(0,pixal1):
#         x = (5 * pitch--5 * pitch)*ix/pixal1+-5 * pitch
#         y = (5 * pitch--5 * pitch)*iy/pixal1+-5 * pitch
...
#     for iz in range(0,pixal2):
#         x = (5 * pitch--5 * pitch)*_arg_list[0]/pixal1+-5 * pitch
#         z = (upperbound-lowerbound)*iz/pixal2+lowerbound
